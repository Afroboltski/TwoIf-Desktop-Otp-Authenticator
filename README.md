...
2. Using an OTP URI, in the form `otpauth://TYPE/LABEL?PARAMETERS`, e.g., `otpauth://totp/ACME:bugs.bunny%40example.com?secret=ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEF&issuer=ACME`
